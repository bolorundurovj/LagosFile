...
@given(
    ...
    st.floats(min_value=0.01, max_value=10000000),  # Positive values (must be > 0)
    st.floats(min_value=0.01, max_value=10000000),  # Positive values (must be > 0)
...
@example(
    bands=[(0, 50000, 0.05), (50001, 100000, 0.1), (100001, 200000, 0.15)],
    allowance_rates={"plant": 0.3, "equipment": 0.2},
    rent_relief_cap=750000,
    cgt_proceeds_threshold=1500000,
    minimum_tax_rate=0.1,
)
@example(
    bands=[(0, 100000, 0.2)],
    allowance_rates={"plant": 0.4},
    rent_relief_cap=600000,
    cgt_proceeds_threshold=1200000,
    minimum_tax_rate=0.12,
)
@example(
    bands=[(0, 75000, 0.08), (75001, 150000, 0.12), (150001, 300000, 0.18)],
    allowance_rates={"plant": 0.25, "equipment": 0.15},
    rent_relief_cap=800000,
    cgt_proceeds_threshold=1600000,
    minimum_tax_rate=0.08,
)
@example(
    bands=[(0, 100000, 0.15)],
    allowance_rates={"plant": 0.35},
    rent_relief_cap=550000,
    cgt_proceeds_threshold=1100000,
    minimum_tax_rate=0.18,
)
@example(
    bands=[(0, 100000, 0.1)],
    allowance_rates={"plant": 0.5},
