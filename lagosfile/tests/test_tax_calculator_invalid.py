...
# Property 30: Invalid tax calculation input rejection
@given(
...
def test_invalid_tax_calculation_input_rejection(
    taxable_income, cgt_proceeds, cgt_gain, allowances
):
    """Test that invalid tax calculation inputs are rejected"""
...
# Property 31: Invalid CGT input rejection
@given(
...
def test_invalid_cgt_input_rejection(
    taxable_income, cgt_proceeds, cgt_gain, allowances
):
    """Test that invalid CGT inputs are rejected"""
    # Create calculator instance
    calculator = TaxCalculator()
...
# Property 32: Invalid CGT gain input rejection
@given(
    st.floats(min_value=0, max_value=10000000),
    st.floats(min_value=0, max_value=1000000),
...
def test_invalid_cgt_gain_input_rejection(
    taxable_income, cgt_proceeds, cgt_gain, allowances
):
    """Test that invalid CGT gain inputs are rejected"""
    # Create calculator instance
    calculator = TaxCalculator()
...
# Property 33: Invalid allowance input rejection
@given(
    st.floats(min_value=0, max_value=10000000),
    st.floats(min_value=0, max_value=1000000),
    st.floats(min_value=0, max_value=1000000),
...
def test_invalid_allowance_input_rejection(
    taxable_income, cgt_proceeds, cgt_gain, allowances
):
    """Test that invalid allowance inputs are rejected"""
    # Create calculator instance
    calculator = TaxCalculator()
